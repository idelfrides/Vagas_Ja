    ...
    <div class="title-content-page mt-5 pt-3 text-muted" id="bg-card">
        <div class="container pb-5">
            <div class="row col-12">
                <h3 class="display-4 mx-auto">Cadastre-se para candidatar-se a uma vaga!</h3>
            </div><br><br><br>
                ...
                <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" class="form-control" name="InputCid" id="InputCid" placeholder="Ex:Sobral" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-6">
